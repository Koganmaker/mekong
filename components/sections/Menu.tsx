      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-12 md:mb-16">
          ...
          <h2 className="font-serif text-[clamp(36px,5.5vw,68px)] leading-[1] tracking-[-0.02em] mt-4">
            Tous nos <em className="text-red-glow font-medium italic">plats</em>.
          </h2>
        </div>

        <div className="rounded-2xl bg-ink-2/60 backdrop-blur-md border border-glass-border p-6 md:p-12">
          {menu.map((cat, i) => (
                ...
                {cat.items.map((item) => (
                  ...
                  >
                    <div className="min-w-0">
                      <div className="text-base font-medium tracking-[-0.005em] group-hover:text-red-glow transition-colors duration-300">
                        {item.name}
                      </div>
